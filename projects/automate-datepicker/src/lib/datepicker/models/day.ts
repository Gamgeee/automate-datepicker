...
export class Day {
    ...
    public get hightLightedStyle(): Partial<CSSStyleDeclaration> | null { return this._hightLightedStyle; }
    ...
    private _hightLightedStyle: Partial<CSSStyleDeclaration> | null = null;
    ...
    constructor(displayedAtMonthNumber: number, dayDate: Date, config: DatePickerConfig) {
        ...
        this._dayLabel = DateHelper.toFormat(dayDate, config.dayLabel ?? Constants.DEFAULT_DAY_FORMAT);
    ...
    public updateDisabledState(config: DatePickerConfig): void {
        ...
        this._setDisabled(Boolean(isDisabledByMinDate || isDisabledByMaxDate || isDisabledBySpecificDate || isDisabledByDayOfWeek));
    }
